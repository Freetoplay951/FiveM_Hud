        ...
        <div className="fixed top-4 left-1/2 -translate-x-1/2 pointer-events-none z-40">
            ...
            >
                ...
                <div className="relative flex items-baseline gap-3">
                    ...
                    >
                        <span className="text-3xl md:text-4xl font-bold tracking-[0.25em] text-primary">
                            COMMUNITY
                        </span>
                        <span className="text-3xl md:text-4xl font-bold tracking-[0.25em] text-secondary">
                            RP
                        </span>
                    </motion.div>
                    ...
                    >
                        <span className="text-3xl md:text-4xl font-bold tracking-[0.25em]" style={{ color: 'hsl(0 100% 50%)' }}>
                            COMMUNITY
                        </span>
                        <span className="text-3xl md:text-4xl font-bold tracking-[0.25em]" style={{ color: 'hsl(188 100% 50%)' }}>
                            RP
                        </span>
                    </motion.div>
                ...
                <motion.div
                    ...
                    style={{
                        background: 'linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.1) 25%, rgba(255,255,255,0.2) 30%, transparent 35%)',
                    }}
                    initial={{ x: "-150%" }}
                    animate={{ x: "150%" }}
                    transition={{
