        ...
        >
          ...
          <div className="relative w-44 h-44">
              ...
              <div 
                ...
                style={{
                  background: `conic-gradient(from -225deg, 
                    ...
                    hsl(var(--stamina) / 0.2) ${speedPercentage * 0.75}%, 
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100">
              <defs>
                <linearGradient id="speedNeonGradient" x1="0%" y1="100%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="hsl(var(--primary))" />
                  <stop offset="40%" stopColor="hsl(var(--stamina))" />
                ...
                return (
                  <g key={speed}>
                    ...
                    <line
                      ...
                      strokeLinecap="round"
                      style={isActive ? { filter: 'drop-shadow(0 0 2px hsl(var(--primary)))' } : {}}
                    />
