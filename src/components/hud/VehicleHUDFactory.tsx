...
export const VehicleHUDFactory = ({ vehicle, visible }: VehicleHUDFactoryProps) => {
  switch (vehicle.vehicleType) {
    case 'plane':
      return <PlaneHUD vehicle={vehicle} visible={visible} />;
    case 'boat':
      return <BoatHUD vehicle={vehicle} visible={visible} />;
    case 'helicopter':
      return <HelicopterHUD vehicle={vehicle} visible={visible} />;
    case 'car':
    default:
      return <VehicleHUD vehicle={vehicle} visible={visible} />;
  }
};
