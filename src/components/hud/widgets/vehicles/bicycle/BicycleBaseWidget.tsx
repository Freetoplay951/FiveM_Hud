...
interface BicycleBaseWidgetProps {
    vehicle: VehicleState;
    visible: boolean;
}

export const BicycleBaseWidget = ({ vehicle, visible }: BicycleBaseWidgetProps) => {
            ...
            <div className="relative w-44 h-44">
                ...
                <svg
                    ...
                    <motion.circle
                        ...
                        r={svgRadius}
                        fill="none"
                        stroke="url(#bicycleBaseGradient)"
                        strokeWidth="3"
                        strokeLinecap="round"
                        filter="url(#bicycleBaseGlow)"
